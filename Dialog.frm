...
Begin VB.Form frmMeals 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ListBox MealTime 
         Height          =   1230
         ItemData        =   "Dialog.frx":002C
         Left            =   3840
         List            =   "Dialog.frx":003F
         TabIndex        =   7
         Top             =   720
         Width           =   3015
      End
...
Private Sub Meal_PresentPopup(PopUp As Object, Un As Variant, X As Single, Y As Single)
...
Private Sub mnuGetNuts_Click()
  Call FNewFood.ShowFood(Meal.Text)
  FNewFood.Show vbModal, Me
End Sub
